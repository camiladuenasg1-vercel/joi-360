# -*- coding: utf-8 -*-
"""
Generador del documento maestro JOI360 (Mapeo de Capacidades, Dependencias y Render).
Lee los archivos markdown en src/ en un orden explicito y arma un .docx real.

Uso:
    python build_docx.py

Para actualizar el documento en una futura iteracion: editar los .md en src/
(o agregar uno nuevo y sumarlo a SECTION_FILES) y volver a correr este script.
Subir la version en VERSION/VERSION_LABEL abajo.
"""
import re
import os
...
# Orden explicito de ensamblado (no depende del nombre de archivo)
SECTION_FILES = [
    "00_portada.md",
    "01_modelo_mental.md",
    "01_backbone.md",
    "02_registro_capacidades.md",
    "03_frente_admin.md",
    "04_frente_mundo_merchant_organizador.md",
    "05_frente_superapp.md",
    "06_frente_pos_y_schema.md",
    "07_design_system.md",
    "08_discrepancias.md",
    "09_backlog.md",
    "10_anexo_anclado.md",
...
for lvl, size, color in [(1, 20, PRIMARY), (2, 15, PRIMARY), (3, 13, DARK), (4, 11, DARK)]:
...
mono_style.paragraph_format.left_indent = Cm(0.5)
...
def render_file(path):
    ...
    while i < n:
        ...
        # subtitulo (linea suelta justo despues del titulo, con "Versión")
        ...
        # parrafo normal (puede continuar en varias lineas hasta blank/estructura)
        para_lines = [stripped]
        i += 1
...
for fname in SECTION_FILES:
    ...
    if not os.path.exists(path):
        print(f"AVISO: falta {fname}, se omite")
        continue
    render_file(path)
