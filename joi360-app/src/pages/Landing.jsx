    ...
    <div className="min-h-screen aura-bg">
      <div className="max-w-[430px] mx-auto pb-20">
        ...
        <div className="px-5 pt-12 pb-5">
          ...
          <div className="flex items-center justify-between mb-6">
            {isFirstTime ? (
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-[#777587] text-xs font-semibold hover:text-[#464555] transition-colors">
          ...
          {/* Título */}
          <p className="text-[#777587] text-[11px] font-mono uppercase tracking-widest mb-2">JOI 360 · ECOSISTEMA</p>
          <h1 className="text-3xl font-black text-[#1b1b24] leading-tight">
            {isFirstTime ? "Elige tu\ncomunidad" : "Explorar\ncomunidades"}
          </h1>
          <p className="text-[#777587] text-sm mt-2 leading-relaxed">
            {isFirstTime
          ...
          <div className="flex items-center gap-3 glass-card rounded-2xl px-4 py-3 mt-4">
            ...
            <input
              className="flex-1 bg-transparent text-[#1b1b24] placeholder-[#c7c4d8] outline-none text-sm"
              placeholder="Buscar por nombre o tipo..."
              value={search}
              onChange={e => setSearch(e.target.value)}
            />
            {search && (
              <button onClick={() => setSearch("")} className="text-[#c7c4d8] hover:text-[#777587] transition-colors">
        ...
        <div className="px-5 space-y-4">
          ...
          {search === "" && (() => {
            ...
            return (
              <div className="space-y-3">
                  ...
                  return (
                    <div key={m.id} className="rounded-3xl overflow-hidden border border-purple-100 glass-card"
                      ...
                      <div className="px-5 pt-5 pb-4">
                        ...
                        <p className="text-xs text-[#464555] leading-relaxed mb-3">{m.descripcion}</p>
                        {m.type === "eventos_rp" && (
                ...
                <div className="h-px bg-[#e4e1ee]/70 my-2"/>
              </div>
            );
          })()}
          ...
          {filtered.length === 0 && publicMundos.length > 0 && (
            <div className="text-center py-12 glass-card rounded-3xl">
              <div className="w-14 h-14 rounded-2xl bg-[#f0ecf9] flex items-center justify-center mx-auto mb-3">
                <span className="material-symbols-outlined text-3xl text-[#c7c4d8]">search_off</span>
              </div>
              <p className="text-[#464555] text-sm font-bold">Sin resultados</p>
              <p className="text-[#777587] text-xs mt-1">Intenta con otro término</p>
              <button onClick={() => setSearch("")}
                className="mt-3 text-[#3525cd] text-xs font-bold hover:underline">
                Limpiar búsqueda
              </button>
            </div>
          )}
          ...
          {publicMundos.length === 0 && (
            <div className="text-center py-16 glass-card rounded-3xl">
              <div className="w-16 h-16 rounded-3xl bg-[#f0ecf9] flex items-center justify-center mx-auto mb-4">
                <span className="material-symbols-outlined text-4xl text-[#c7c4d8]">public_off</span>
              </div>
              <p className="text-[#464555] text-base font-bold mb-1">Aún no hay comunidades</p>
              <p className="text-[#777587] text-sm leading-relaxed max-w-[220px] mx-auto">
                Las comunidades las habilita RedPontis desde el panel de administración.
              </p>
              <div className="mt-6 mx-6 p-4 bg-[#f0ecf9] rounded-2xl text-left">
                <p className="text-[#3525cd] text-xs font-bold mb-1">¿Eres administrador?</p>
                <p className="text-[#777587] text-xs">Ve a <b>joi360-admin.vercel.app</b> y crea un mundo en estado ACTIVO.</p>
              </div>
              <button onClick={() => { logoutUser(); nav("/auth"); }}
                className="mt-6 text-[#777587] text-xs font-semibold hover:text-[#464555] transition-colors flex items-center gap-1 mx-auto">
          ...
          {filtered.map(m => {
            ...
            return (
              <div key={m.id}
                className={`glass-card rounded-3xl overflow-hidden border transition-all ${vc.border} ${isJoined ? "ring-2 ring-[#3525cd]/20" : ""}`}>
                ...
                <div className={`${vc.bg} px-5 pt-5 pb-4`}>
                  ...
                  <p className="text-[#464555] text-xs mt-3 leading-relaxed line-clamp-2">
                  ...
                  <div className="flex flex-wrap gap-3 mt-3">
                    ...
                    <span className="text-[#777587] text-xs flex items-center gap-1">
                      ...
                      <b className="text-[#1b1b24]">{comCount}</b> comercios
                    </span>
                    <span className="text-[#777587] text-xs flex items-center gap-1">
        ...
        {!isFirstTime && (
          <div className="px-5 mt-6 text-center">
            <button onClick={() => nav("/hub")}
              className="glass-card px-6 py-3 rounded-2xl text-[#3525cd] text-sm font-bold tap-active inline-flex items-center gap-2">
              <span className="material-symbols-outlined fill text-base">home</span>
              Volver a mi hub
            </button>
          </div>
